...
| Claim / assumption | Required evidence |
|---|---|
| A benchmark $/km is a valid project estimate | Site-specific concept/FEED estimate on equivalent scope. |
| A positive economic frontier equals savings | Complete pricing of both architectures on equal scope. |
| A tariff/regulatory treatment applies or does not apply | Current utility/regulatory/legal determination for the specific configuration. |
