...
| **C1 — Reference architecture** | Current physical/commercial project architecture and deployment strategy. | `docs/10-core/*Reference_Architecture*`, current project vision and deployment files |
...
| **C4 — Working research** | Research methods, screening, cost studies and source analyses requiring validation before project claims. | `docs/30-site-screening/`, `docs/40-economics/`, `docs/50-research/` |
