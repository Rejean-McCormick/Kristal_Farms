...
('remaining_unpriced_kristal_farms_budget_conservative_cad','CAD','derived_economic_frontier','Remaining unpriced Kristal Farms budget — conservative reference frontier',false,'Not savings/NPV. Uses lower export project ratios and higher fibre funding proxy.'),
('remaining_unpriced_kristal_farms_budget_optimistic_cad','CAD','derived_economic_frontier','Remaining unpriced Kristal Farms budget — optimistic reference frontier',false,'Not savings/NPV. Uses higher export project ratios and lower fibre funding proxy.'),
