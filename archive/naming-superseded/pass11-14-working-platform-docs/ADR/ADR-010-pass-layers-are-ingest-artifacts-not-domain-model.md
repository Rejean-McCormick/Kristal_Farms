# ADR-010 — Research-pass layers are ingest artifacts, not the domain model

**Status:** Accepted

Pass-numbered GeoJSON files remain useful for reproducibility and exchange. They are no longer treated as the application source of truth.

Examples:

- Pass 10 analysis windows -> `system.ingestion_job.request_geometry`;
