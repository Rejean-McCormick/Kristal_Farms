...
## Purpose
Pass 13 is the first integrated atlas snapshot built for the Kristal Geospatial Platform model rather than as a sequence of standalone GeoJSON layers. It connects hydrology to community, marine, telecom, energy and legacy environment context through canonical IDs, relations, evidence and observations.
